...
("India", "Sri Lanka", "win"),  # India wins against Sri Lanka
("England", "Pakistan", "win"),  # England wins against Pakistan
("Australia", "Sri Lanka", "loss"),  # Australia loses against Sri Lanka
("New Zealand", "Pakistan", "loss"),  # New Zealand loses against Pakistan
("South Africa", "Australia", "win"),  # South Africa wins against Australia again (to even the series)
("Sri Lanka", "England", "win"),  # Sri Lanka wins against England
